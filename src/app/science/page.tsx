  ...
  return (
    <div className="min-h-screen bg-bg-light dark:bg-bg-dark">
      <div className="w-full">
        <h1 className="text-4xl font-bold text-text-primary-light dark:text-text-primary-dark mb-8">The Science</h1>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 space-y-8">
          <div>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Training Stress Score (TSS)</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Chronic Training Load (CTL)</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Acute Training Load (ATL)</h2>
            <p className="text-base text-text-secondary-light dark:text-text-secondary-dark">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Training Stress Balance (TSB)</h2>
            <p className="text-base text-text-secondary-light dark:text-text-secondary-dark mb-3">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-text-primary-light dark:text-text-primary-dark mb-3">Training Principles</h2>
            <p className="text-base text-text-secondary-light dark:text-text-secondary-dark mb-3">
